...
% later be used in the derivation of the mapping.
	...
	hhand_q2cart.thumb_tip_past1 = 0;
   	...
   	bhand_q2cart.left_tip_past2 = 0;
	bhand_q2cart.right_tip_past2 = 0;
	bhand_q2cart.nonspread_tip_past2 = 0;
    
	bhand_q2cart.left_tip_past1 = 0;
	bhand_q2cart.right_tip_past1 = 0;
	bhand_q2cart.nonspread_tip_past1 = 0;
end
	...
	bhand_q2cart.left_tip = 0;
	bhand_q2cart.right_tip = 0;
	bhand_q2cart.nonspread_tip = 0;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% inside a loop in another script.
    ...
    if(simulate_hhand_only == 0)    
        ...
        % Derive the bhand points for the derived bhand joint vector:
         ...
         % optimise the shift transformation for best bhand-hhand match:
                  shift_MutualSelection;
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    end
