...
raster90 = linspace(pi/2,pi,train_pair_resolution);
...
for nonspread_motor_index = 1:train_pair_resolution
   ...
   nonspread_y_train(iteration)= bhand_q2cart.nonspread_tip(y_axis);
...
plot3(left_x_train,left_y_train,left_z_train,'r+',...
      right_x_train,right_y_train,right_z_train,'bx',...
      nonspread_x_train,nonspread_y_train,nonspread_z_train,'go')
grid on