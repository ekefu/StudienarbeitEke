...
% middle_calibration  
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Boundary values for the middle finger joints from medical literatur:                  
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	hhand.middle.prox.rt_Q_range(max_val) = pi/2;                  
	hhand.middle.media.rt_Q_range(max_val) = (5*pi)/9;
	hhand.middle.distal.rt_Q_range(max_val) = pi/4;
	hhand.middle.abduct.rt_Q_range(max_val) = pi/18; % A guess value; not found in medical literature. This should be calibrated. 
%    	hhand.middle.abduct.rt_Q = -q_10_raster(angle_index);
...
%
% hhand.middle.prox.rt_Q_range(max_val) = cglove.middle.prox.rt_Q;                  
% hhand.middle.media.rt_Q_range(max_val) = cglove.middle.media.rt_Q;
% hhand.middle.distal.rt_Q_range(max_val) = cglove.middle.distal.rt_Q;
% hhand.middle.abduct.rt_Q_range(max_val) = cglove.middle.abduct.rt_Q;
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% is 128. A subset of this spektrum will be used, 
    ...
    hhand.middle.prox.raster   = linspace(0,hhand.middle.prox.rt_Q_range(max_val),128);        % 90°
    hhand.middle.media.raster  = linspace(0,hhand.middle.media.rt_Q_range(max_val),128);       % 100°
    hhand.middle.distal.raster = linspace(0,hhand.middle.distal.rt_Q_range(max_val),128);      % 45°
  	hhand.middle.abduct.raster = -linspace(0,hhand.middle.abduct.rt_Q_range(max_val),128);      % -10°
